...
import com.jijia.camunda.dto.FlowEngineDTO;
import com.jijia.camunda.dto.json.ChildNode;
import com.jijia.camunda.dto.json.SettingsInfo;
import com.jijia.camunda.entity.*;
import com.jijia.camunda.exception.WorkFlowException;
import com.jijia.camunda.mapper.TemplateGroupMapper;
import com.jijia.camunda.service.*;
import com.jijia.camunda.utils.BpmnModelUtils;
import com.jijia.camunda.utils.IdWorker;
import com.jijia.camunda.utils.SpringContextHolder;
import com.jijia.camunda.utils.WorkFlowConstants;
import com.jijia.camunda.vo.TemplateGroupVo;
...
import static com.jijia.camunda.utils.BpmnModelUtils.connect;
import static com.jijia.camunda.utils.BpmnModelUtils.createStartEvent;
import static com.jijia.camunda.utils.WorkFlowConstants.END_EVENT_ID;
...
//        bpmnModel.addProcess(process);
        ...
        StartEventBuilder startEvent = createStartEvent(process);
            ...
            try {
                lastNode = BpmnModelUtils.create(startEvent, START_EVENT_ID,childNode,sequenceFlows,childNodeMap);
