 ...
 */
@Component
@TaskAnnotation(TaskCompleteType = TaskApplyType.ASSIGN)
public class AssignTaskImpl extends AbstractTaskApplyStrategy {
    ...
    public void CompleteTask(HandleDataDTO handleDataDTO) {
        ...
        taskService.setAssignee(task.getId(), handleDataDTO.getTransferUserId().toString());
    }
}
