...
public class OpFinancialStatementVo extends BaseEntity
{
    ...
    /** 订单号/合同号 */
    @ExcelProperty(value = {"应收账款台账","订单号/合同号"})
    private String orderNumber;

    /** 报告单位 */
    @ExcelProperty(value = {"应收账款台账","报告单位"})
    private String reportUnit;

    /** 工程名称 */
    @ExcelProperty(value = {"应收账款台账","工程名称"})
    private String projectMsg;

    /** 总金额 */
    @ExcelProperty(value = {"应收账款台账","总金额"})
    private BigDecimal amount;

    /** 本期应收金额 */
    @ExcelProperty(value = {"应收账款台账","本期应收金额"})
    private BigDecimal receivableAmount;

    /** 该笔款支付期限 */
    @DateTimeFormat(pattern = "yyyy/MM/dd")
    @JsonFormat(pattern = "yyyy/MM/dd")
    @ExcelProperty(value = {"应收账款台账","该笔款支付期限"},converter = LocalDateConverter.class)
    private LocalDate receivableTime;

    /** 发票号码 */
    @ExcelProperty(value = {"应收账款台账","发票号码"})
    ...
    /** 发票类型 */
    @ExcelProperty(value = {"应收账款台账","发票类型"})
    private String invoiceType;

    /** 发票金额 */
    @ExcelProperty(value = {"应收账款台账","发票金额"})
    ...
    /** 到账金额 */
    @ExcelProperty(value = {"应收账款台账","到账金额"})
    private BigDecimal receivableNumber;

    /** 未付金额 */
    @ExcelProperty(value = {"应收账款台账","未付金额"})
    private BigDecimal unpaidAmount;

    /** 支付方式 */
    @ExcelProperty(value = {"应收账款台账","支付方式"})
    private String payType;

    /** 回款率 */
    @ExcelProperty(value = {"应收账款台账","回款率"})
    private String reimbursementRate;

    /** 是否是吉嘉真实业务 */
    @ExcelProperty(value = {"应收账款台账","是否是吉嘉真实业务"} , converter = StringConverter.class)
    private String isReal;

    /** 下单人 */
    @ExcelProperty(value = {"应收账款台账","下单人"})
    private String publisher;

    /** 业务经理 */
    @ExcelProperty(value = {"应收账款台账","业务经理"})
    private String businessManager;

    @ExcelProperty(value = {"应收账款台账","备注"})
    private String remark;

    /** 吉嘉入账金额 */
    @ExcelProperty(value = {"应收账款台账","吉嘉入账金额"})
    private BigDecimal creditedAmount;

    /** 回扣 */
    @ExcelProperty(value = {"应收账款台账","回扣"})
    private BigDecimal kickback;

    /** 已收税金 */
    @ExcelProperty(value = {"应收账款台账","已收税金"})
    private BigDecimal taxesCollected;

    /** 吉嘉实际收入 */
    @ExcelProperty(value = {"应收账款台账","吉嘉实际收入"})
    private BigDecimal realAmount;

    @ExcelProperty(value = {"应收账款台账","是否导入"} , converter = StringConverter.class)
