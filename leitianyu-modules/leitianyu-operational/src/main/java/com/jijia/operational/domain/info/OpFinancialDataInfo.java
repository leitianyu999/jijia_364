 ...
 * @date 2024-01-21
 */
public class OpFinancialDataInfo extends BaseEntity
{
    ...
    private List<Long> financialCodes;

    public List<Long> getFinancialCodes() {
        return financialCodes;
    }

    public void setFinancialCodes(List<Long> financialCodes) {
