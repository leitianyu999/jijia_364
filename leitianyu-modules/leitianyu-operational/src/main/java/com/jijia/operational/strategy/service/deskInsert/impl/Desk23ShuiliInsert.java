 ...
 */
@Component
@DeskInsertTypeAnnotation(deskInsertType = DeskInsertType.SHUI_LI_23)
public class Desk23ShuiliInsert extends AbstractDeskInsertStrategy {
    ...
    public Desk23ShuiliInsert(IOpParameterService opParameterService) {
    ...
    private static final String SHUI_LI_ENTRUST = "SL-JJW-";
    ...
    public OpDeskVo creatNumber(OpDeskVo opDeskVo) {
        ...
        opDeskVo.setReportSerialNumber(SHUI_LI);
        opDeskVo.setEntrustSerialNumber(SHUI_LI_ENTRUST);
        //生成报告编号和委托编号
