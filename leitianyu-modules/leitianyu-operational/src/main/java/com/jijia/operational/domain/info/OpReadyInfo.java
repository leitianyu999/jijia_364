 ...
 * @date 2023-02-04
 */
public class OpReadyInfo extends BaseEntity
{
    ...
    public List<Long> getReadyIds() {
        return readyIds;
    }

    public void setReadyIds(List<Long> readyIds) {
